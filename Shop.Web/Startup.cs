...
namespace Shop.Web
{
    public class Startup
    {
        ...
        {
            // Las siguientes lineas son para indicar al proyecto qué características deberan tener
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseStaticFiles();
            // Añadimos la siguiente línea para indicar que mi aplicación utiliza autenticación
